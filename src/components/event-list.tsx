  ...
  return (
    <div className="flex flex-col gap-4 p-4">
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center flex-1">
        <h1 className="text-xl sm:text-2xl font-bold">Eventos</h1>
        ...
        <div className="sm:ml-auto w-full sm:w-auto">
          <button
            ...
            className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 w-full sm:w-auto flex items-center justify-center gap-2"
          >
            <IoIosAddCircle size={20} />
            <span className="sm:hidden">Cadastrar Evento</span>
          </button>
        </div>
      </div>
